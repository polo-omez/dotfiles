...
hl.workspace_rule({ workspace = "r[11-18]", monitor = secondaryMonitor })
hl.workspace_rule({ workspace = "10", monitor = secondaryMonitor, default = true })
hl.workspace_rule({ workspace = "r[2-9]", monitor = mainMonitor })
